...
{
   database_length = 0;
   this[database_length++] = new SearchPage("index.html", "GX MODS - Home", "GX MODS  Welcome to my website! Here you can find different modifications of applications, programs and operating systems, both from me and from others.  Attention! The author of the site has nothing to do with modifications from other authors! I do not vouch for their performance!  by Gexoty  Home   ", "");
   this[database_length++] = new SearchPage("news.html", "GX MODS - News", "GX MODS  04/21/2022 Transition to HTML5. Bug fixes. New products added  1. Minecraft RePack 1.16.4 2. VirtualBox 5.2.44 3. Devel Studio Aero Edition Other minor changes...  04/20/2022 Website redesign. Bug fixes. Made a mobile version of the site.  04/19/2022 Site creation and hosting. The first product, Xubuntu GX, has been added.   by Gexoty  News   ", "");
